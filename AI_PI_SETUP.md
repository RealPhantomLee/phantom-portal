...
This guide configures the AI Pi (192.168.1.15) with 4 optimized Ollama models for distributed inference in the Phantom Portal cluster. The AI Pi will handle embeddings and specialized tasks, offloading work from the main Pi.
...
## Step 1: Pull Models on AI Pi (192.168.1.15)
...
**AI Pi (192.168.1.15) — Specialization: Embeddings**
...
- Check `nomic-embed-text` is loaded on AI Pi: `curl http://192.168.1.15:11434/api/tags`
- Verify AI Pi Ollama is running: `ps aux | grep ollama`
- Check network latency: `ping -c 5 192.168.1.15`
