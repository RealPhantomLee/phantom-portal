...
# Run this on 192.168.1.15 to pull optimal Ollama models for distributed inference
# This sets up the AI Pi with 4 specialized models for the Phantom Portal cluster

set -e  # Exit on error

echo "=========================================="
echo "AI Pi Model Pulldown (192.168.1.15)"
echo "=========================================="
echo ""
...
echo "  • AI Pi (192.168.1.15): llama3.2:3b, mistral:7b, nomic-embed-text, phi3:mini"
...
echo "  3. Run: curl http://192.168.1.15:11434/api/tags to verify from Main Pi"
echo ""
