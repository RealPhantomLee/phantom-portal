...
```bash
VITE_API_BASE=https://cyberdeck.REDACTED_TAILNET.ts.net
VITE_WS_SECURITY=wss://cyberdeck.REDACTED_TAILNET.ts.net/ws/security
VITE_WS_SYNC=wss://cyberdeck.REDACTED_TAILNET.ts.net/ws/sync
```
