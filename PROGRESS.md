...
### Pending
- ⏳ **Tailscale cert**: `tailscale cert cyberdeck.REDACTED_TAILNET.ts.net` (manual, required for PWA service workers)
...
2. ⏳ Generate Tailscale cert: `tailscale cert cyberdeck.REDACTED_TAILNET.ts.net`
3. ⏳ Test backend health endpoint: `curl https://cyberdeck.REDACTED_TAILNET.ts.net/health`
