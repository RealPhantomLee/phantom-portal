...
tailscale cert cyberdeck.tail3ab12c.ts.net

# Cert will be placed at:
# ~/.local/share/tailscale/certs/cyberdeck.tail3ab12c.ts.net.crt
# ~/.local/share/tailscale/certs/cyberdeck.tail3ab12c.ts.net.key
```
...
uvicorn backend.main:app --host 0.0.0.0 --port 8000 \
  --ssl-certfile ~/.local/share/tailscale/certs/cyberdeck.tail3ab12c.ts.net.crt \
  --ssl-keyfile ~/.local/share/tailscale/certs/cyberdeck.tail3ab12c.ts.net.key
```
...
```bash
# Create a note
curl -X POST https://cyberdeck.tail3ab12c.ts.net/api/notes \
...
# Get cameras
curl https://cyberdeck.tail3ab12c.ts.net/api/security/cameras

# Get HA devices
curl https://cyberdeck.tail3ab12c.ts.net/api/ha/devices
```
...
websocat wss://cyberdeck.tail3ab12c.ts.net/ws/security
...
On mobile device:
1. Visit https://cyberdeck.tail3ab12c.ts.net
...
4. Connectivity: `ping cyberdeck.tail3ab12c.ts.net` (from Tailscale device)
