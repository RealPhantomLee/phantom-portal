...
The Phantom Portal is **live and accessible** at: **`https://cyberdeck.REDACTED_TAILNET.ts.net`** (Tailscale devices only)
...
#### 3. Install on Mobile
- iOS/Android: Open `https://cyberdeck.REDACTED_TAILNET.ts.net` via Tailscale app
...
# Database OK?
curl https://cyberdeck.REDACTED_TAILNET.ts.net/api/notes/ | jq .

# Clusters healthy?
curl https://cyberdeck.REDACTED_TAILNET.ts.net/api/cluster/status | jq .nodes
