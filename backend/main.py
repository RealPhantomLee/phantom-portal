...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["https://cyberdeck.REDACTED_TAILNET.ts.net", "http://localhost:3000"],
...
if __name__ == "__main__":
    import uvicorn
    uvicorn.run(app, host="0.0.0.0", port=8000, ssl_certfile="/home/jolly/Projects/phantom/cyberdeck.REDACTED_TAILNET.ts.net.crt", ssl_keyfile="/home/jolly/Projects/phantom/cyberdeck.REDACTED_TAILNET.ts.net.key")
