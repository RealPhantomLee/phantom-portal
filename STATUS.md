...
**User Actions**
1. **Generate Tailscale cert**: `tailscale cert cyberdeck.tail3ab12c.ts.net`
...
1. `tailscale cert cyberdeck.tail3ab12c.ts.net`
...
3. Visit `https://cyberdeck.tail3ab12c.ts.net` from Tailscale device
